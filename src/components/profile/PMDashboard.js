    ...
    <div className="pm-dashboard-container">
      ...
      <main style={{
        ...
        <div className="main-dashboard-grid">
          ...
          <section className="dashboard-section animate-fade-in" style={{ animationDelay: '0.8s', cursor: 'pointer', width: winWidth < 600 ? '100%' : '100%', boxSizing: 'border-box' }} onClick={() => navigate('/birthdays')}>
          ...
          <section className="dashboard-section animate-fade-in" style={{ animationDelay: '1.0s', cursor: 'pointer', width: winWidth < 600 ? '100%' : '100%', boxSizing: 'border-box' }} onClick={() => navigate('/holidays')}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
